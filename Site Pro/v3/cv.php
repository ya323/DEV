...
?>
    <section class="top-page">
        <header class="header"> 
            <img src="images/cv logo.jpg" alt="cv logo" style="float: right;">
            <?php
        ...
        <div class="landing-page">
            ...
            <h3>Formation</h3>
            <li>INGENIEUR GENERALISTE, OPTION : INDUSTRIE ET SERVICE</li>
            De 2023 à 2025 IMT NORD D'EUROPE, Douai, France
            <li>INGENIEUR D'ETAT, OPTION: GENIE INDUSTRIEL</li>
            De 2021 à 2024 Ecole Nationale Supérieure des Mines de Rabat, Rabat, Morocco
